...
import DensityNotificationView from '../../components/DensityNotificationView'
...
export const CompanyDetailsScreen = () => {
  ...
  const GAME_HEIGHT_COLLAPSED = SCREEN_HEIGHT - HERO_HEIGHT - 188
  ...
  const bottomHeartRef = useRef<View>(null)
  ...
  const handleDoubleTapLike = useCallback(
    (e?: {
      ...
      if (now - lastTapRef.current < 300) {
        if (!bottomHeartRef.current) return
        ...
        if (e?.nativeEvent) {
          ...
          bottomHeartRef.current.measure((x, y, width, height, pageX, pageY) => {
            Animated.timing(animPos, {
              toValue: {
                x: pageX + width / 2 - LOTTIE_SIZE / 2,
                y: pageY + height / 2 - LOTTIE_SIZE / 2,
              },
              duration: 600,
              useNativeDriver: true,
            }).start(() => {
  ...
  const modalNotificationRef = useRef<ModalizeHandle>(null)
  ...
  const onNotificationPress = () => {
    if (modalNotificationRef.current) {
      console.warn('ModalNotificationRef var')
      modalNotificationRef.current.open()
    } else {
      console.warn('ModalNotificationRef null')
    }
  }
  ...
  const likes = Array.from({ length: 50 }, (_, index) => ({
    id: String(index + 1),
    name: `Place ${index + 1}`,
  ...
  return (
    <>
      ...
      >
          ...
          <View style={{ position: 'absolute', zIndex: 2, left: 16, bottom: 50 }}>
            ...
            >
              ...
              >
                ...
                >
                  <Text variant="body2" style={{ color: theme.colors.success }}>
                    |
                  </Text>
                  <GroupIcon width={24} height={24} color={theme.colors.success} />
                  <Text variant="body2" style={{ color: theme.colors.success }}>
                    {t('densityWithPercentage', { percentage: 80 })}
                  </Text>
                </View>
              </View>
            </View>
            <View
              style={[
                ...
                { flexDirection: 'row', flex: 1, gap: theme.spacing.sm, alignItems: 'center' },
              ]}
            >
        ...
        <>
          ...
          <View style={{ paddingHorizontal: 16, marginTop: 12 }}>
            ...
            >
              <View ref={bottomHeartRef} collapsable={false}>
                {/* LIKE BUTTON FIRST ITEM */}
                <TouchableOpacity
                  onPress={onLikePress}
                  activeOpacity={0.9}
                  style={{
                ...
                >
                  ...
                  <Text
                    variant="h6"
                    style={{ color: '#fff', position: 'absolute', top: 4, fontSize: 12 }}
                  >
                    {likeCount}
                  </Text>
                </TouchableOpacity>
            ...
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => navigation.navigate('CompanyMenu', { item })}
              style={{
                borderRadius: 12,
                paddingHorizontal: 16,
                paddingVertical: 12,
                // borderWidth: 1,
                borderColor: 'rgba(166, 91, 255, 0.35)',
            ...
            >
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text variant="h5">Menüyü Aç</Text>
                ...
                >
                  <ArrowRightIcon width={16} height={16} color={theme.colors.text} />
                </View>
              </View>
            </TouchableOpacity>

            <Divider text={t('liveDensity')} />
            ...
            >
              <Image
                source={{ uri: 'https://digitalvol.com/richmedias/serkan/ads/6.jpeg' }}
      ...
      <DensityNotificationView ref={modalNotificationRef} onCheckin={handleCheckin} />
    </>
  )
}
